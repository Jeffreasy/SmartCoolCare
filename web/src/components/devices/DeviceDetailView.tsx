...
export default function DeviceDetailView({ device, activeTab: propActiveTab = 'overview', onTabChange }: DeviceDetailViewProps) {
    const updateSettings = useMutation(api.devices.updateSettings);
    const [localActiveTab, setLocalActiveTab] = useState<'overview' | 'history' | 'settings'>(propActiveTab);
    ...
    return (
        <div className="flex flex-col h-full">
            {/* Tab Navigation */}
            <div className="flex w-full mb-6 shrink-0">
